...
export const parseHtmlText = (text) => ent.decode(text, { scope: 'all' });
...
export const isImageFile = (name) =>
  SupportImageType.contains(getFileExtension(name.toLowerCase()));

export const isVideoFile = (name) =>
  SupportVideoType.contains(getFileExtension(name.toLowerCase()));
