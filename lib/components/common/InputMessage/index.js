...
import { useCurrentChatRoom, useCurrentUser, useQiscus } from '../../../contexts/hooks';
import { useAtomValue } from 'jotai/utils';
import { attachmentAtom, loginCheckedAtom, replayMessageAtom } from '../../../contexts/state';
...
const InputMessage = (props) => {
  ...
  const qiscus = useQiscus()
	...
	const enableInput = useMemo(() => loginChecked && username != null && currentRoom != null, [loginChecked, username, currentRoom]);
  ...
  const placeholder = useMemo(() => {
	...
	const sendTyping = useCallback(debounce(() => {
			...
			<View style={styles.containerInput}>
				...
				{(message !== '' || message !== undefined) && (
					<View>
						...
						>
							{renderSendMessage ? renderSendMessage : <SendMessage disabled={disableButton} />}
						</TouchableOpacity>
					</View>
				)}
			</View>
