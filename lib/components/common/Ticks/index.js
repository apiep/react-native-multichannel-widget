...
const Ticks = (props) => {
  ...
  const getTickSent = () => {
    ...
    return (
      <Image
        source={require('../../../assets/ic_check_sent.png')}
        style={style.image}
      />
    );
  };
  ...
  const getTickDelivered = () => {
    ...
    return (
      <Image
        source={require('../../../assets/ic_check_delivered.png')}
        style={style.image}
      />
    );
  };
  ...
  const getTickRead = () => {
    ...
    return (
      <Image
        source={require('../../../assets/ic_check_read.png')}
        style={style.image}
      />
    );
  };
  ...
  const getTickPending = () => {
    ...
    return (
      <Image
        source={require('../../../assets/ic_check_pending.png')}
        style={style.image}
      />
    );
  };
